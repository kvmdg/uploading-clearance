...
if(isset($_POST['submit']))
  {
    ...
    //Query for data updation
     $query=mysqli_query($con, "update  tblusers set FirstName='$fname',LastName='$lname', MobileNumber='$contno', stud_id='$stud_id', Address='$add' where ID='$eid'");
...
<a href="change-image.php?userid=<?php echo $row['ID'];?>">Change Image</a>
        ...
        <div class="form-group">
        	<input type="number" class="form-control" name="stud_id" value="<?php  echo $row['stud_id'];?>" required="true">
        </div>
