...
$query=mysqli_query($con, "insert into tblusers(FirstName,LastName, MobileNumber, stud_id, Address,ProfilePic) value('$fname','$lname', '$contno', '$stud_id', '$add','$imgnewfile' )");
if ($query) {
...
<div class="signup-form">
    <form  method="POST" enctype="multipart/form-data" >
        ...
        <div class="form-group">
        	<input type="text" class="form-control" name="stud_id" placeholder="Enter your Student ID" required="true">
        </div>
